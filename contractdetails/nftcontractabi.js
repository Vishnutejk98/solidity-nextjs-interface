export const NFT_CONTRACT_ABI = [
  ...
  { inputs: [], name: "NotNextOwner", type: "error" },
  { inputs: [], name: "OnlyAllowedSeaDrop", type: "error" },
  ...
  { inputs: [], name: "SignersMismatch", type: "error" },
  { inputs: [], name: "TokenGatedMismatch", type: "error" },
  {
    inputs: [],
